        ...
        dbr.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(allConversations != null && allConversations.size() != 0)
                    rva = new RecyclerViewAdapter(getApplicationContext(), R.layout.expence_list, allConversations, HomeActivity.this);
                else
                    rva = new RecyclerViewAdapter(getApplicationContext(), R.layout.expence_list, new ArrayList<Chat>(), HomeActivity.this);
